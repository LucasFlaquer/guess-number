...
export function Digit(props: Props) {
  ...
  return (
    <svg width={props.width} height={props.height} viewBox="0 0 56 100" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path 
        ...
        fill={props.topLed ? props.trueColor : falseColor}
      />
      <path 
        ...
        fill={props.topLeftLed ? props.trueColor : falseColor}
      />
      <path 
        ...
        fill={props.topRightLed ? props.trueColor : falseColor}
      />
      <path 
        ...
        fill={props.bottomLed ? props.trueColor : falseColor}
      />
      <path 
        ...
        fill={props.bottomLeftLed ? props.trueColor : falseColor}
      />
      <path 
